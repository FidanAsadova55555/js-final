...
const accardionD = document.getElementById("accordions");
  ...
  const contactD = document.querySelector("#justcontact");

  const renderContactData = async (data) => {
    if (data && contactD) {
      data.forEach((data) => {
        const contactHtml = `
...
${data?.icon}                            </div>
                            <div class="contact-content">
                                <div class="contact-title-wrap"><p class="contact-title">${data?.title}</p></div>
                                <div class="contact-address-wrap"><p class="contact-address">${data?.text}</p></div>
                            </div>
                        </div>
                    </div>
                          
        `;
        contactD.innerHTML += contactHtml;
      });
